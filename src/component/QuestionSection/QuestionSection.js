...
export default function QuestionSection({question, nextQuestion, total, questionNo, progress, checkUserAnswer,maxScore, score}) {
          ...
          <CardActions>
            { question['incorrect_answers'].map(key =>
                <Button variant={answered === decodeURIComponent(key)? "contained" :"outlined"} 
                        color="secondary" key={decodeURIComponent(key)} 
            ...
            <Button variant={answered === decodeURIComponent(question['correct_answer'])? "contained" :"outlined"} 
                    color="secondary" key={decodeURIComponent(question['correct_answer'])} 
